...
export type CustomScalarQueryQuery = { __typename?: 'Query', date?: any | null | undefined };
...
export type NoArgsSubscriptionSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type NoArgsSubscriptionSubscription = { __typename?: 'Subscription', noArgs?: string | null | undefined };
...
export const CustomScalarQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"customScalarQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"date"}}]}}]} as unknown as DocumentNode<CustomScalarQueryQuery, CustomScalarQueryQueryVariables>;
...
export const WithVariablesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"WithVariables"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"A"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"B"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"C"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"D"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"E"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Enumerable"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"F"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"InputMap"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"withArgs"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"int"},"value":{"kind":"Variable","name":{"kind":"Name","value":"A"}}},{"kind":"Argument","name":{"kind":"Name","value":"float"},"value":{"kind":"Variable","name":{"kind":"Name","value":"B"}}},{"kind":"Argument","name":{"kind":"Name","value":"boolean"},"value":{"kind":"Variable","name":{"kind":"Name","value":"C"}}},{"kind":"Argument","name":{"kind":"Name","value":"string"},"value":{"kind":"Variable","name":{"kind":"Name","value":"D"}}},{"kind":"Argument","name":{"kind":"Name","value":"enum"},"value":{"kind":"Variable","name":{"kind":"Name","value":"E"}}},{"kind":"Argument","name":{"kind":"Name","value":"inputMap"},"value":{"kind":"Variable","name":{"kind":"Name","value":"F"}}}]}]}}]} as unknown as DocumentNode<WithVariablesQuery, WithVariablesQueryVariables>;
export const NoArgsSubscriptionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"NoArgsSubscription"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"noArgs"}}]}}]} as unknown as DocumentNode<NoArgsSubscriptionSubscription, NoArgsSubscriptionSubscriptionVariables>;